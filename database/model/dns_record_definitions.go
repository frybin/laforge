...
JSON Sample
-------------------------------------
{    "id": "VMe`B^LRjVLstXodfy_xpJVHr",    "type": "ChZTAbTTEwxuKbK]uqQYPSIic",    "name": "_ei\\^kWyFUnmLuaWPwQBZBFup"}



*/

// DNSRecordDefinitions struct is a row record of the dns_record_definitions table in the laforge-2 database
/*
type DNSRecordDefinitions struct {
    //[ 0] id                                             UUID                 null: false  primary: true   isArray: false  auto: false  col: UUID            len: -1      default: []
...
func (d *DNSRecordDefinitions) TableName() string {
	return "dns_record_definitions"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (d *DNSRecordDefinitions) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (d *DNSRecordDefinitions) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (d *DNSRecordDefinitions) Validate(action Action) error {
	return nil
}
