...
var file_laforge_proto_agent_laforge_proto_agent_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x98, 0x0c, 0x0a, 0x07, 0x6c,
...
var file_laforge_proto_agent_laforge_proto_agent_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_laforge_proto_agent_laforge_proto_agent_proto_goTypes = []interface{}{
	...
	(*HeartbeatRequest)(nil),    // 21: laforge_proto_agent.HeartbeatRequest
	(*HeartbeatReply)(nil),      // 22: laforge_proto_agent.HeartbeatReply
...
var file_laforge_proto_agent_laforge_proto_agent_proto_depIdxs = []int32{
	23, // 0: laforge_proto_agent.Reboot.timestamp:type_name -> google.protobuf.Timestamp
	23, // 1: laforge_proto_agent.RebootReportRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	21, // 18: laforge_proto_agent.laforge.GetHeartBeat:input_type -> laforge_proto_agent.HeartbeatRequest
	1,  // 19: laforge_proto_agent.laforge.GetPing:output_type -> laforge_proto_agent.PingReply
	3,  // 20: laforge_proto_agent.laforge.GetHostTest:output_type -> laforge_proto_agent.HostTestReply
	20, // 21: laforge_proto_agent.laforge.GetPort:output_type -> laforge_proto_agent.PortReply
	5,  // 22: laforge_proto_agent.laforge.DownloadFile:output_type -> laforge_proto_agent.FileReply
	9,  // 23: laforge_proto_agent.laforge.ExecuteFile:output_type -> laforge_proto_agent.FileDefinitionReply
	9,  // 24: laforge_proto_agent.laforge.ExtractFile:output_type -> laforge_proto_agent.FileDefinitionReply
	9,  // 25: laforge_proto_agent.laforge.DeleteFile:output_type -> laforge_proto_agent.FileDefinitionReply
	9,  // 26: laforge_proto_agent.laforge.ValidateFile:output_type -> laforge_proto_agent.FileDefinitionReply
	9,  // 27: laforge_proto_agent.laforge.ValidateFileHash:output_type -> laforge_proto_agent.FileDefinitionReply
	11, // 28: laforge_proto_agent.laforge.DeleteDir:output_type -> laforge_proto_agent.DirectoryReply
	11, // 29: laforge_proto_agent.laforge.ValidateDir:output_type -> laforge_proto_agent.DirectoryReply
	7,  // 30: laforge_proto_agent.laforge.RunCommand:output_type -> laforge_proto_agent.CommandReply
	24, // 31: laforge_proto_agent.laforge.RequestReboot:output_type -> google.protobuf.Empty
	14, // 32: laforge_proto_agent.laforge.ReportReboot:output_type -> laforge_proto_agent.RebootReportReply
	16, // 33: laforge_proto_agent.laforge.SetAdminPassword:output_type -> laforge_proto_agent.PasswordReply
	18, // 34: laforge_proto_agent.laforge.ValidateProcess:output_type -> laforge_proto_agent.ProcessReply
	22, // 35: laforge_proto_agent.laforge.GetHeartBeat:output_type -> laforge_proto_agent.HeartbeatReply
